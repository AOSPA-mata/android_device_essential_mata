...
PRODUCT_COPY_FILES += \
    device/essential/mata/configs/public.libraries.txt:$(TARGET_COPY_OUT_VENDOR)/etc/public.libraries.txt

# Audio
include hardware/qcom/audio/configs/msm8998/msm8998_no_configs.mk
...
PRODUCT_COPY_FILES += \
    ...
    device/essential/mata/configs/libnfc-brcm.conf:$(TARGET_COPY_OUT_SYSTEM)/etc/libnfc-brcm.conf \
...
PRODUCT_COPY_FILES += \
    device/essential/mata/configs/touchscreen.idc:system/usr/idc/touchscreen.idc
